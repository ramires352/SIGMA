 ...
 * @author ramires
 */
public class TelaVendaGraosAjuda extends javax.swing.JFrame {
     
    /** Creates new form TelaAltProduto
     * @param  */
    public TelaVendaGraosAjuda() {
        initComponents();
        
        textNome.setText("Soja");
        boxTipo.setSelectedIndex(0);
        textPreco.setText("14.99");
        textQtde.setText("20.00");
    ...
    private void initComponents() {
        ...
        boxTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Soja" }));
        ...
        jLabel1.setText("Ajuda na venda de grãos");

        textQtde.setEditable(false);
        textQtde.setText("10.00");
        ...
        jLabel20.setText("Colocar da forma \"0.00\", com um \".\" separando a parte decimal.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVendaGraosAjuda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
